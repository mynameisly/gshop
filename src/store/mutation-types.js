...
export const RECEIVE_CATEGORYS = 'categorys'//接收地址
...
export const RECEIVE_RATINGS = 'receive_ratings'//接收用商家评价数组
...
export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops'//接收搜索的s商家信息